...
#[test]
fn test_infile() {
  let pos = Pos::infile(1, 123, 456, 100);
  assert_eq!(pos.ver(), 1);
...
fn test_infile_with_flag() {
  let pos = Pos::infile_with_flag(1, Flag::InfileLz4, 123, 456, 100);
  assert_eq!(pos.ver(), 1);
  assert_eq!(pos.wal_id(), 123);
  assert_eq!(pos.offset(), 456);
  assert_eq!(pos.len(), 100);
...
#[test]
fn test_file() {
  let pos = Pos::file(1, 123, 789, 200);
  assert_eq!(pos.ver(), 1);
  assert_eq!(pos.wal_id(), 123);
...
fn test_file_with_flag() {
  let pos = Pos::file_with_flag(1, Flag::FileLz4, 123, 789, 200);
  assert_eq!(pos.ver(), 1);
  assert_eq!(pos.wal_id(), 123);
  assert_eq!(pos.file_id(), 789);
  assert_eq!(pos.len(), 200);
...
#[test]
fn test_tombstone() {
  let pos = Pos::tombstone(1, 123, 456);
  assert_eq!(pos.ver(), 1);
  assert_eq!(pos.wal_id(), 123);
  assert_eq!(pos.offset(), 456);
  assert_eq!(pos.len(), 0);
...
#[test]
fn test_hash() {
  let p1 = Pos::infile(1, 1, 2, 10);
  let p2 = Pos::infile(1, 1, 2, 10);
  let p3 = Pos::infile(1, 1, 3, 10);

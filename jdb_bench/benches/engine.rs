...
fn main() {
  ...
  #[cfg(feature = "jdb")]
  run_bench::<jdb_bench::JdbSlabAdapter>(&rt, "jdb_slab", "/tmp/bench_jdb", &data, duration);

  #[cfg(feature = "fjall")]
  run_bench::<jdb_bench::FjallAdapter>(&rt, "fjall", "/tmp/bench_fjall", &data, duration);

  #[cfg(feature = "rocksdb")]
  run_bench::<jdb_bench::RocksDbAdapter>(&rt, "rocksdb", "/tmp/bench_rocksdb", &data, duration);
}

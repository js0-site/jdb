...
/// ```
///
/// Serializing and deserializing `BinaryFuse16` filters can be enabled with the [`bitcode`] feature.
///
...
mod test {
  ...
  use crate::{BinaryFuse16, DmaSerializable, Filter, FilterRef, bfuse16::BinaryFuse16Ref};

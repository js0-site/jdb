...
/// ```
///
/// Serializing and deserializing `BinaryFuse8` filters can be enabled with the [`bitcode`] feature.
///
...
mod test {
  ...
  use crate::{BinaryFuse8, DmaSerializable, Filter, FilterRef, bfuse8::BinaryFuse8Ref};

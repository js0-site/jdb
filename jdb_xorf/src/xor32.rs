...
use crate::{Filter, xor_contains_impl, xor_from_impl};
...
/// ```
///
/// Serializing and deserializing `Xor32` filters can be enabled with the [`bitcode`] feature.
///

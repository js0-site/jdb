...
fn test_empty_input() {
  ...
  let pef = Pef::new_with_conf(&data, Conf { block_size: 128, ..Default::default() });
...
fn test_duplicates() {
  ...
  let pef = Pef::new_with_conf(&data, Conf { block_size: 2, ..Default::default() });
...
fn test_large_gaps() {
  ...
  let pef = Pef::new_with_conf(&data, Conf { block_size: 10, ..Default::default() });
...
fn test_block_boundaries() {
  ...
  let pef = Pef::new_with_conf(&data, Conf { block_size: 4, ..Default::default() }); // chunks: [0..6], [8..14], etc.
...
fn test_iter_multi_seek_and_skip() {
  ...
  let pef = Pef::new_with_conf(&data, Conf { block_size: 10, ..Default::default() }); // small blocks

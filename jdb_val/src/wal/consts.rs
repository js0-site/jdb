...
/// Small read buffer size (512B, for small records)
/// 小读取缓冲区大小（512 字节，用于小记录）
pub const SMALL_BUF_SIZE: usize = 512;

/// Block cache size (64KB, same as ITER_BUF_SIZE)
/// 块缓存大小（64KB，与迭代器缓冲区相同）

...
*This is a fork of [sile/scalable_cuckoo_filter](https://github.com/sile/scalable_cuckoo_filter) maintained by js0-site.*

[![autoscale_cuckoo_filter](https://img.shields.io/crates/v/autoscale_cuckoo_filter.svg)](https://crates.io/crates/autoscale_cuckoo_filter)
[![Documentation](https://docs.rs/autoscale_cuckoo_filter/badge.svg)](https://docs.rs/autoscale_cuckoo_filter)
[![Actions Status](https://github.com/js0-site/jdb/workflows/CI/badge.svg)](https://github.com/js0-site/jdb/actions)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

A variant of [Cuckoo Filter][cuckoo filter] whose size automatically scales as necessary.

[Documentation](https://docs.rs/autoscale_cuckoo_filter)

...
pub(crate) const ERR_SST: &str = "sst write error";
pub(crate) const ERR_DISCONN: &str = "flush task disconnected";

pub(crate) type FlushRes<S, D> = (Disk<S, D>, Result<Meta, <S as Sst>::Error>);

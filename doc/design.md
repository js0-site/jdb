...
| L3 | **jdb_wal** | 预写日志，原子性与持久性 | [5_wal.md](5_wal.md) |
| L3 | **jdb_vlog** | 值日志，大 Value 存储与 GC | [6_vlog.md](6_vlog.md) |
| L3 | **jdb_page** | 缓冲池，用户态页缓存 | [7_page.md](7_page.md) |
| L4 | **jdb_index** | B+ Tree 索引 + Binary Fuse Filter | [8_index.md](8_index.md) |
| L5 | **jdb_sub** | SubTable 实现，MVCC，Compaction | [9_sub.md](9_sub.md) |
| L6 | **jdb_api** | Engine/Table 实现，对外 API | [10_api.md](10_api.md) |
| L3-5 | **jdb_meta** | Schema 持久化，子表元数据索引 | [11_meta.md](11_meta.md) |
| - | **jdb** | 顶层封装，re-export | - |
